  ...
  <div class="grid-item">
      <div class="card"> 
        <div class="card_container">
          ...
          <a type="button" class="btn btn-primary btn-block" onclick="downloadFile('https://cdn-142.anonfiles.com/f5v9w2E9xf/43f42d35-1643445953/20220130-final.mp4')" href="#">Download</a>
        </div>
      </div>
    </div>
{% endfor %}
