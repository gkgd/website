  ...
  <div class="grid-item">
      <div class="card"> 
        <div class="card_container">
          ...
          <a type="button" id="download-url" class="btn btn-primary btn-block" href="https://cdn-142.anonfiles.com/f5v9w2E9xf/43f42d35-1643445953/20220130-final.mp4">Download</a>
        </div>
      </div>
    </div>
{% endfor %}
